...
SELECT first_name, salary, salary+300 AS incentive FROM employees;
...
SELECT first_name, job_id, commission_pct*100 AS 보너스율 FROM employees
...
SELECT first_name || ' ' || last_name || ' 사원의 급여는 ' || salary || '달러 입니다.' AS 사원정봉 FROM employees
